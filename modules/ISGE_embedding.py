...
class GraphEmbedding(EmbeddingModule):
    def __init__(self, node_features, node_depth, memory, neighbor_finder, time_encoder, n_layers,
        ...
        super(GraphEmbedding, self).__init__(node_features, node_depth, memory,
                                             neighbor_finder, time_encoder, n_layers,
                                             n_node_features, n_time_features,
                                             embedding_dimension, device, dropout)
    ...
    def compute_embedding(self, source_nodes, destination_nodes, source_timestamps, destination_timestamps, n_neighbors=50,
        ...
        # neighbor_depth = self.node_depth[neighbors, :]
        # neighbor_features = neighbor_features + neighbor_depth
...
class GraphAttentionEmbedding(GraphEmbedding):
    def __init__(self, node_features, node_depth, memory, neighbor_finder, time_encoder, n_layers,
                 n_node_features, n_time_features, embedding_dimension, device,
                 n_heads=2, dropout=0.1, use_memory=True):
        super(GraphAttentionEmbedding, self).__init__(node_features, node_depth, memory,
                                                      neighbor_finder, time_encoder, n_layers,
                                                      n_node_features,
                                                      n_time_features,
...
def get_embedding_module(module_type, node_features, node_depth, memory, neighbor_finder,
